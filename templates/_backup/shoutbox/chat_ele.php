    ...
    <div class="dw-post-wrap mb-3 shadow-sm border-0" id="<?= $ChatDetail['id'] ?>" style="border-radius: 12px; background: var(--surface);">
        <div class="dw-post-layout">
            ...
            <div class="dw-post-author-col" style="background: transparent;">
                <div class="dw-post-author-sticky text-center">
                    <div class="position-relative d-none d-md-inline-block">
                        <img class="dw-avt rounded-circle shadow-sm" src="<?= getAvtUser($UserDetail) ?>" style="width: 50px; height: 50px; object-fit: cover; border: 2px solid white;" />
                        <?php if ($UserDetail['online_status'] === 'online'): ?>
                    ...
                    <div class="mt-1 ml-md-0 ml-2">
                        <?php if (!isset($user) || (isset($user) && $user['id'] != $UserDetail['id'])): ?>
                        <a href="javascript:window.tag('@<?= $UserDetail['nick'] ?> ', '')" class="badge badge-light shadow-sm" title="Gắn thẻ" style="color: var(--accent);"><i class="fa fa-at"></i> Tag</a>
            ...
            <div class="dw-post-content-col">
                ...
                <div class="chat-content text-dark p-3 pt-2" style="word-wrap: break-word; font-size: 14px; line-height: 1.6;">
                    <?= $ChatDetail['comment'] ?>
                </div>
            </div>
        </div>
